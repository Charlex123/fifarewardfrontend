               ...
               <div className={footerstyles.footermain_in}>
                  <div className={footerstyles.footer_c1}>
                     ...
                     <div className={footerstyles.f_c}>
                        ...
                        <div><a href='https://discord.gg/aQ7bjShzHy' rel='noopener noreferrer' ><FaDiscord className={footerstyles.navdrbdwnbrandicon}/> <span className={footerstyles.brnd}>Discord</span></a> </div>
                  ...
                  <div className={footerstyles.footer_c2}>
                     ...
                     <div className={footerstyles.f_c}>
                        <div>
                           <a onClick={showcomingsoonContdown} rel='noopener noreferrer' ><IoIosFootball className={footerstyles.navdrbdwnbrandicon}/> <span className={footerstyles.brnd}>Betting</span></a>
                        </div>
                        <div>
                           <a onClick={showcomingsoonContdown}  rel='noopener noreferrer' ><FaUserGroup className={footerstyles.navdrbdwnbrandicon}/> <span className={footerstyles.brnd}>Fan Forum</span></a>
                        </div>
                        <div>
                           <a onClick={showcomingsoonContdown}  rel='noopener noreferrer' ><GiMineralHeart className={footerstyles.navdrbdwnbrandicon}/> <span className={footerstyles.brnd}>Farm</span></a>
                        </div>
                        <div>
                           <a onClick={showcomingsoonContdown}  rel='noopener noreferrer' ><FaArtstation className={footerstyles.navdrbdwnbrandicon}/> <span className={footerstyles.brnd}>NFT MarketPlace</span></a>
                        </div>
                        <div>
                           <a onClick={showcomingsoonContdown}  rel='noopener noreferrer' ><FaCircleDollarToSlot className={footerstyles.navdrbdwnbrandicon}/> <span className={footerstyles.brnd}>Stake</span></a>
                        </div>
                        <div>
                           <a onClick={showcomingsoonContdown}  rel='noopener noreferrer' ><GiGamepad className={footerstyles.navdrbdwnbrandicon}/> <span className={footerstyles.brnd}>Gaming</span></a>
                        </div>
                     </div>
                  </div>
               </div>
